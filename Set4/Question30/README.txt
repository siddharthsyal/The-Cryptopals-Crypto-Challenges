...
Note :
	MD4 code has been developed from scratch using the RFC1320.
	Please take a note about the endian-ness of the platform  where the code is being compiled. The code is suitable for little-endian based platforms.